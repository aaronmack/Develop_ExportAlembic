...
# Form implementation generated from reading ui file 'import_alembic_v02.ui'
#
# Created: Mon Sep  2 10:55:35 2019
...
class Ui_Widget_ImportAlembic(object):
    def setupUi(self, Widget_ImportAlembic):
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.widget_leftmain)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.widget = QtWidgets.QWidget(self.widget_leftmain)
        ...
        self.lineEdit_alembicpath = QtWidgets.QLineEdit(self.widget)
        self.lineEdit_alembicpath.setObjectName("lineEdit_alembicpath")
        self.horizontalLayout_2.addWidget(self.lineEdit_alembicpath)
        self.btn_go_previous_level = QtWidgets.QPushButton(self.widget)
        self.btn_go_previous_level.setMinimumSize(QtCore.QSize(20, 20))
        self.btn_go_previous_level.setStyleSheet("QPushButton{background:rgb(94, 94, 94);border-radius:5px;}QPushButton:hover{background:rgb(195, 15, 25)}")
        self.btn_go_previous_level.setObjectName("pushButton")
        self.horizontalLayout_2.addWidget(self.btn_go_previous_level)
        self.btn_searchpath = QtWidgets.QPushButton(self.widget)
        ...
        self.horizontalLayout_2.addWidget(self.btn_searchpath)
        ...
        self.gridLayout_3.addWidget(self.listWidget_alembiclist, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Widget_ImportAlembic):
        ...
        self.btn_go_previous_level.setText(QtWidgets.QApplication.translate("Widget_ImportAlembic", "L", None, -1))
